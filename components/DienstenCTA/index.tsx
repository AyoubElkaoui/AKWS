          ...
          <div className="flex flex-wrap gap-8 md:flex-nowrap md:items-center md:justify-between md:gap-0">
            ...
            >
              <h2 className="mb-4 w-11/12 text-3xl font-bold text-black dark:text-white xl:text-sectiontitle4">
                Sluit je vandaag nog aan en verbeter je prestaties
              </h2>
              <p className="text-manatee dark:text-waterloo">
                Ontvang toegang tot geavanceerde tools en oplossingen die zijn ontworpen om jouw productiviteit en succes naar een hoger niveau te tillen. Laat ons je ondersteunen bij het realiseren van je doelen.
              </p>
            </motion.div>
            <motion.div
              variants={{
